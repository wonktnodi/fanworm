...
//	for _, ln := range lns {
//		if err := base.AddRead(p, ln.fd, nil, nil); err != nil {
//			return err
//		}
//	}
//	var mu sync.Mutex
...
//				}
//				lock()
//				err = base.AddRead(p, fd, &c.readon, &c.writeon)
//				if err != nil {
//					unlock()
//					syscall.Close(fd)
//					return err
//				}
//				err = base.AddWrite(p, fd, &c.readon, &c.writeon)
//				if err != nil {
//					unlock()
//					syscall.Close(fd)
//					return err
...
//		} else if !c.wake {
//			c.wake = true
//			err = base.AddWrite(p, c.fd, &c.readon, &c.writeon)
//		}
//		unlock()
//		if err != nil {
//			panic(err)
...
//			if err = base.AddWrite(p, c.fd, &c.readon, &c.writeon); err != nil {
//				goto fail
//			}
//			fdconn[nfd] = c
//			idconn[id] = c
...
//		opened:
//			filladdrs(c)
//			if err = base.AddRead(p, c.fd, &c.readon, &c.writeon); err != nil {
//				goto fail
//			}
//			if events.Opened != nil {
//				unlock()
...
//			if len(c.outbuf)-c.outpos == 0 {
//				if !c.wake {
//					if err = base.DelWrite(p, c.fd, &c.readon, &c.writeon); err != nil {
//						goto fail
//					}
//				}
//				if c.action != None {
